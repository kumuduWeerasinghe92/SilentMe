...
public class EventFragment extends Fragment {
    ...
    public void setData(User user)
    {
        ...
        mDatabase.child(FirebaseTables.usersToEvents + "/" + currentUser.getPhoneNumber() + "/hosted").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        mDatabase.child(FirebaseTables.usersToEvents + "/" + currentUser.getPhoneNumber() + "/invited").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(!dataSnapshot.exists())
                {
    ...
    private class eventsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    {
        public class EventViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,
            ...
            public EventViewHolder(View view) {
                ...
                this.eStatus = (ImageView) view.findViewById(R.id.event_status);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            if (type == EVENT)
            {
                ...
                String teventStartDate = currentEvent.getDate();
                String teventStartTime = currentEvent.getTime();
                String teventEndDate = currentEvent.getendDate();
                String teventEndTime = currentEvent.getendTime();

                int statusev = getEventState(teventStartDate,teventStartTime,teventEndDate,teventEndTime);



                if(statusev ==1)
                {
                    eventView.eStatus.setImageResource(R.drawable.ic_eventstarted);
                }else if(statusev ==0)
                {
                    eventView.eStatus.setImageResource(R.drawable.ic_eventpending);
                }else if(statusev ==-1)
                {
                    eventView.eStatus.setImageResource(R.drawable.ic_eventended);
                }else
                    {
                        eventView.eStatus.setVisibility(View.INVISIBLE);
                    }
